...
class KnowledgeGraphWeb(DialogueBase):
    ...
    def ask(self, text: str) -> str:
        ...
        relative_Knowledge, self.entity_triplet = self.VectorizedTextSimilarityMatching.query(text,self.top_n,self.databases)
    ...
    def get_entity_triplet(self):
        return self.entity_triplet